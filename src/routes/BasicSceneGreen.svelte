...
import { circOut, linear, sineInOut, sineOut, quadInOut, quadOut, quartOut, quintOut } from 'svelte/easing';
import { IcosahedronBufferGeometry, NoToneMapping } from 'three';
...
//Ico
    ...
    var yScale = gsap.timeline({repeat: -1, delay: 0, repeatDelay: 0, yoyo:true});
